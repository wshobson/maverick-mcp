...
| `exec-plans/active/2026-09-13-pandas-ta-removal.md` | current | engineering | Execution plan for the pandas-ta removal (4 tasks: feature engineering, dependency drop, pandas 3, bookkeeping). |
