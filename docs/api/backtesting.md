...
extra (`vectorbt`, `numba`, `scikit-learn`, `scipy`). On a base install with
the extra absent, the server still boots cleanly and registers **zero**
`backtesting_*` tools -- see [Installation](#installation) below.
