...
class ExaTestRunner:
    ...
    def __init__(self):
        ...
        self.test_file = (
            self.project_root / "tests" / "test_exa_research_integration.py"
        )
        self.benchmark_script = (
            self.project_root / "scripts" / "benchmark_exa_research.py"
        )
    ...
    def validate_environment(self) -> bool:
        ...
        try:
            ...
            maverick_mcp_spec = importlib.util.find_spec("maverick_mcp")

            if pytest_spec is None or maverick_mcp_spec is None:
    ...
    def show_test_info(self):
        ...
        print("   • Python 3.12+")
        print("   • pytest and project dependencies")
        print("   • EXA_API_KEY environment variable (for integration tests)")
        print("   • Redis (optional, for caching tests)")
...
Examples:
  ...
  python scripts/run_exa_tests.py --info              # Show test information
    ...
    test_group.add_argument(
        "--slow", action="store_true", help="Run slow/performance tests"
    )
    test_group.add_argument(
    ...
    test_group.add_argument(
        "--info", action="store_true", help="Show test suite information"
    )
    test_group.add_argument(
    ...
    parser.add_argument(
        "--focus",
        choices=["fundamentals", "technicals", "sentiment", "competitive"],
